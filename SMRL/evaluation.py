...
def evaluate(output_dir, data_path_train, data_path_test=None, binary=False):
    ...
    results, exp_dirs_result_summary = load_results(output_dir)
    ...
    for k in keys:
        ...
        # # YS
        # import pdb; pdb.set_trace()
        # # result['train']['pred'].shape
        # v = np.array([eval_results[0]['train'][k], eval_results[1]['train'][k], eval_results[2]['train'][k], eval_results[3]['train'][k]])
        # v = np.array([eval_results[0]['train'][k], eval_results[1]['train'][k]])
        # eval_results[0]['train'][k].shape
        # eval_results[1]['train'][k].shape
    ...
    return eval_dict, configs_out, exp_dirs_result_summary
